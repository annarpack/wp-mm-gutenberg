/**
 * BLOCK: MemberMouse Forgot Password
 *
 */
 ...
 */
registerBlockType( 'mm/forgot-password-block', {
	title: __( 'MM - Forgot Password Block' ),
	description: __( 'Insert MemberMouse Forgot Password Form' ),
	icon: {
	 ...
	 */
	edit: ( props ) => {
		const className = getBlockDefaultClassName( 'mm/forgot-password-block' );
		return ( [
			/*eslint-disable*/
			<InspectorControls>
				<Panel>
					...
					<PanelBody title={ 'Email/Username Field Settings' } initialOpen={ false }>
						<PanelRow className={ 'mm-gb-panel-row mm-gb-flex-col' }>
							<TextControl
								label={ 'Label Text' }
				...
				<form method="post">
					<div className="mm-forgot-password">
						<div className="form-group email-group">
							<label htmlFor="email">{ props.attributes.usernameLabelText }</label>
							<input type="text" id="email" name="email" className="mm-field email-field disabled" placeholder={ props.attributes.usernamePlaceholderText } disabled />
						</div>
